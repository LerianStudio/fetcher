...
// Source: golang-plugin-boilerplate/internal/adapters/postgres/example (interfaces: Repository)
//
// Generated by this command:
//
//	mockgen --destination=example.postgresql.mock.go --package=example . Repository
//
