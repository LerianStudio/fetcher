...
type ProducerRepository interface {
	ProducerDefault(ctx context.Context, exchange, key string, message model.JobQueuePayload) (*string, error)
}
...
func (prmq *ProducerRabbitMQRepository) ProducerDefault(ctx context.Context, exchange, key string, queueMessage model.JobQueuePayload) (*string, error) {
