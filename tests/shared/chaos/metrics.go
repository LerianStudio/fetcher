...
// This is the CORE version without recovery/stability tracking.
// For extended metrics with recovery tracking, implement RecoveryMetricsProvider.
...
// Returns an empty map if no ErrorClassifier is configured.
...
// This calculates throughput based on total requests and chaos duration.
...
// Verify ChaosMetrics implements MetricsProvider interface.
