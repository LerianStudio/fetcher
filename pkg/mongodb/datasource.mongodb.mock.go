...
// Source: github.com/LerianStudio/fetcher/pkg/mongodb (interfaces: Repository)
...
func (m *MockRepository) QueryWithAdvancedFilters(arg0 context.Context, arg1 string, arg2 []string, arg3 map[string]job.FilterCondition) ([]map[string]interface{}, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRepositoryMockRecorder) QueryWithAdvancedFilters(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
