	...
	tests := []struct {
		...
		},
		{
			...
			connection: Connection{
				...
				PasswordEncrypted: "encrypted-password",
				SSL: &SSLConfig{
					Mode: "skip-verify", // MySQL mode, invalid for PostgreSQL
					CA:   "ca-cert",
				},
			},
			expectError: true,
		...
		},
		{
			...
			connection: Connection{
				...
				PasswordEncrypted: "encrypted-password",
				SSL: &SSLConfig{
					Mode: "require", // PostgreSQL mode, invalid for MySQL
					CA:   "ca-cert",
				},
			},
			expectError: true,
		...
		},
		{
			...
			connection: Connection{
				...
				PasswordEncrypted: "encrypted-password",
				SSL: &SSLConfig{
					Mode: "verify-full", // PostgreSQL mode, invalid for MongoDB
					CA:   "ca-cert",
				},
			},
			expectError: true,
		...
		},
		{
			...
			connection: Connection{
				...
				PasswordEncrypted: "encrypted-password",
				SSL: &SSLConfig{
					Mode: "verify-full", // PostgreSQL mode, invalid for Oracle
					CA:   "ca-cert",
				},
			},
			expectError: true,
		...
		},
		{
			...
			connection: Connection{
				...
				PasswordEncrypted: "encrypted-password",
				SSL: &SSLConfig{
					Mode: "require", // PostgreSQL mode, invalid for SQL Server
					CA:   "ca-cert",
				},
			},
			expectError: true,
