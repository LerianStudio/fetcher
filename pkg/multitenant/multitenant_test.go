...
func TestTenantIsolation_S3KeyIsolation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			keyA, _ := tms3.GetS3KeyStorageContext(ctxA, tt.objectName)
			keyB, _ := tms3.GetS3KeyStorageContext(ctxB, tt.objectName)
...
func TestTenantContext_MissingJWTFallback(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			s3Key, _ := tms3.GetS3KeyStorageContext(ctx, "reports/data.json")
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expectTenantID == "" {
				...
				s3Key, _ := tms3.GetS3KeyStorageContext(ctx, "some/object.json")
...
func TestTenantContext_EmptyTenantPropagation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			s3Key, _ := tms3.GetS3KeyStorageContext(ctx, tt.objectName)
...
func TestContextPropagation_EndToEndFlow(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			s3Key, _ := tms3.GetS3KeyStorageContext(ctx, "output/data.json")
...
func TestContextPropagation_NoCrossGoroutineLeakage(t *testing.T) {
	...
	for i := 0; i < iterationCount; i++ {
		...
		go func() {
			...
			// Verify S3 key
			s3Key, _ := tms3.GetS3KeyStorageContext(ctx, "obj.json")
...
func TestContextPropagation_ChildContextInheritsTenantID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			s3Key, _ := tms3.GetS3KeyStorageContext(grandchild, "nested/object.json")
...
func TestSingleTenantFallback_AllInfrastructure(t *testing.T) {
	...
	t.Run("s3_keys_unmodified_without_tenant", func(t *testing.T) {
		...
		for _, name := range objectNames {
			result, _ := tms3.GetS3KeyStorageContext(ctx, name)
