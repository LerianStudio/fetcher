...
func TestValidateFieldsInSchemaPostgres(t *testing.T) {
	tests := []struct {
		name           string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			var count int32
			got := ValidateFieldsInSchemaPostgres(tt.expectedFields, tt.schema, &count)
...
func TestCreateRowMap(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := createRowMap(tt.columns, tt.values, mockLogger)
